...
import br.com.petcolumbia.api_pet_columbia.old.dtos.mappers.OwnerMapper;
...
import br.com.petcolumbia.api_pet_columbia.old.dtos.requests.ownerDtos.OwnerUpdatePasswordDto;
...
public class OwnersController {
   ...
   public ResponseEntity<OwnerInfoResponseDto> searchOwner(@PathVariable Integer id) {
      OwnerModel owner = ownerService.getOwnerById(id);
