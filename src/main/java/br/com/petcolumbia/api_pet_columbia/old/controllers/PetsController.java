...
import br.com.petcolumbia.api_pet_columbia.old.dtos.mappers.PetMapper;
...
import br.com.petcolumbia.api_pet_columbia.old.services.OwnerService;
...
public class PetsController {
    ...
    @SecurityRequirement(name = "Bearer")
    public ResponseEntity<PetResponseDto> searchPet(@PathVariable Integer id, @PathVariable Integer ownerId) {
        PetModel pet = petService.findPetById(id, ownerId);
